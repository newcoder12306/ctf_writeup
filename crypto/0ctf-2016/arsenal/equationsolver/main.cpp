...
// todo:convert it to lookuptable function
...
int solve3(int argc, const char* argv[])
{
    ...
    */
    ...
    tmp = fastinvmixcolumns({147,190,78,179});
    printf("%d %d %d %d\n", tmp[0], tmp[1], tmp[2], tmp[3]);
    ...
    // watch out for shared variables and mutexing
        ...
        for (int k171=0;k171<256;k171++)
        {
            ...
            for (int k162=0;k162<256;k162++)
            {
                ...
                for (int k193=0;k193<256;k193++)
                {
                    ...
                    /*
                    if (OK[0] == 216 && OK[1] == 119 && OK[2] == 125 && OK[3] == 186)
                    {
                        time(NULL);
                    }
                    */
                    ...
                    */
                    ...
                    // 0.75s below
                    //if (!abcdtables[0].contains(akey)) continue;
